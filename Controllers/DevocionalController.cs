...
namespace ApiPG.Controllers
{
    ...
    public class DevocionalController : ControllerBase
    {
        ...
        /// </summary>
        [HttpPost]
        public async Task<ActionResult<DevocionalDto>> CreateDevocional([FromBody] CreateDevocionalDto createDto)
        {
            try
            {
        ...
        /// </summary>
        [HttpPut("{id}")]
        public async Task<ActionResult<DevocionalDto>> UpdateDevocional(int id, [FromBody] UpdateDevocionalDto updateDto)
        {
            try
            {
                if (!ModelState.IsValid)
        ...
        public async Task<ActionResult<DevocionalDto>> SaveStep1([FromBody] DevocionalStep1Dto step1Dto)
        {
            try
            {
                if (!ModelState.IsValid)
        ...
        /// </summary>
        [HttpPut("wizard/{id}/step2")]
        public async Task<ActionResult<DevocionalDto>> SaveStep2(int id, [FromBody] DevocionalStep2Dto step2Dto)
        {
            try
            {
                if (!ModelState.IsValid)
        ...
        /// </summary>
        [HttpPut("wizard/{id}/step3")]
        public async Task<ActionResult<DevocionalDto>> SaveStep3(int id, [FromBody] DevocionalStep3Dto step3Dto)
        {
            try
            {
                var userId = GetCurrentUserId();
        ...
        /// </summary>
        [HttpPost("draft")]
        public async Task<ActionResult<DevocionalDto>> SaveDraft([FromBody] SaveDraftDto draftDto)
        {
            try
            {
                var userId = GetCurrentUserId();
        ...
        /// </summary>
        [HttpGet("volunteer/{voluntarioId}")]
        ...
        /// </summary>
        [HttpGet("{id}/preview")]
        public async Task<ActionResult<DevocionalPreviewDto>> GetPreview(int id)
        {
            try
            {
