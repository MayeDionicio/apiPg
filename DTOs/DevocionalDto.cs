...
namespace ApiPG.DTOs
{
    ...
    public class CrearDevocionalDto
    {
    ...
    public class ActualizarDevocionalDto
    {
        [MaxLength(200)]
    ...
    public class DevocionalPaso1Dto
    {
        [Required(ErrorMessage = "El título es requerido")]
        public string Titulo { get; set; } = string.Empty;
    ...
    public class DevocionalPaso2Dto
    {
    ...
    public class DevocionalPaso3Dto
    {
        // Mensaje Principal
        public string? Objetivo { get; set; }
        public string? Idea { get; set; }
    ...
    public class DevocionalVistaPreviaDto
    {
        public string Titulo { get; set; } = string.Empty;
        public DateTime? FechaProgramada { get; set; }
        public string? VoluntarioAsignado { get; set; }
