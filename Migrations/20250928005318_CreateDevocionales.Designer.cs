...
namespace ApiPG.Migrations
{
    ...
    [Migration("20250928005318_CreateDevocionales")]
    partial class CreateDevocionales
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ApiPG.Models.Attendance", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("ApiPG.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            PasswordHash = "QSNk6NjkEQY5MPIFVC9cEVVPerlnGk2oA7V5puh9dew=",
                            RoleId = 5,
            ...
            modelBuilder.Entity("ApiPG.Models.Devocional", b =>
                {
                    b.HasOne("ApiPG.Models.User", "CreatedByUser")
                        .WithMany()
                        .HasForeignKey("CreatedByUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("ApiPG.Models.User", "UpdatedByUser")
                        .WithMany()
                        .HasForeignKey("UpdatedByUserId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("ApiPG.Models.User", "VoluntarioAsignadoUser")
                        .WithMany()
