...
namespace ApiPG.Services
{
    public interface IDevocionalService
    {
        ...
        Task<DevocionalDto> CreateAsync(CreateDevocionalDto createDto, int createdByUserId);
        Task<DevocionalDto?> UpdateAsync(int id, UpdateDevocionalDto updateDto, int updatedByUserId);
        Task<bool> DeleteAsync(int id);
        Task<bool> ActivateAsync(int id);

        // Métodos específicos para el wizard
        Task<DevocionalDto> SaveStep1Async(DevocionalStep1Dto step1, int userId);
        Task<DevocionalDto> SaveStep2Async(int devocionalId, DevocionalStep2Dto step2, int userId);
        Task<DevocionalDto> SaveStep3Async(int devocionalId, DevocionalStep3Dto step3, int userId);
        Task<DevocionalDto> SaveDraftAsync(SaveDraftDto draftDto, int userId);
        ...
        // Utilidades
        Task<DevocionalPreviewDto?> GetPreviewAsync(int id);
